...
const Payment = sequelize.define('Payment', {
    ...
    transaction_id: { type: DataTypes.STRING(500), allowNull: false, unique: true, },
    payment_description: { type: DataTypes.TEXT, allowNull: false, },
    payment_type: { type: DataTypes.ENUM('MONTHLY', 'YEARLY'), allowNull: false, },
    payment_status: { type: DataTypes.ENUM('PENDING', 'COMPLETED', 'CANCELED'), allowNull: false, },
