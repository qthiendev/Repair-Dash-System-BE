...
module.exports = async () => {
    try {
        ...
        const migrationFile = path.resolve(__dirname, '../../database/migrations/latest-rddb.migration.sql');
        const seederFile = path.resolve(__dirname, '../../database/seeders/latest-rddb.seeder.sql');
